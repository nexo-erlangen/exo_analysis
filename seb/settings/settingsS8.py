...
dataList = []
for fn in os.listdir(preProcessDir + 'S2Th/p2_pz/'):
    # runNum = [int(s) for s in fn.split('_') if s.isdigit()][0] 
    # if runNum >= 4500 and runNum <= 4600:
    dataList.append( preProcessDir + 'S2Th/p2_pz/%s' % fn )
...
mcList = [preProcessDir + 'SourceS8_Th228.root']

# SS paths
SSoutDir = '/home/vault/capm/mppi025h/analysis/histo/'
SSoutFile = 'SS_S8Th.root'

# MS paths
MSoutDir = '/home/vault/capm/mppi025h/analysis/histo/'
MSoutFile = 'MS_S8Th.root'

# Plot paths
plotDir = '/home/vault/capm/mppi025h/plot_scripts/plots/cart_S8Th/'
